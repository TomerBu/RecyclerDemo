...
public class ItemClickSupport {
    ...
    public static synchronized ItemClickSupport addTo(RecyclerView view) {
        ItemClickSupport support = (ItemClickSupport) view.getTag(R.id.toolbar);
        if (support == null) {
    ...
    private ItemClickSupport(RecyclerView recyclerView) {
        ...
        mRecyclerView.setTag(R.id.toolbar, this /*save this single ItemClickSupport instance in the tag of the views*/);
